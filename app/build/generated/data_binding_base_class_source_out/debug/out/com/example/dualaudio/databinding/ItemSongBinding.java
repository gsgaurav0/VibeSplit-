...
public final class ItemSongBinding implements ViewBinding {
  ...
  private ItemSongBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardArt,
  ...
  public static ItemSongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cardArt;
      CardView cardArt = ViewBindings.findChildViewById(rootView, id);
      if (cardArt == null) {
        break missingId;
      }
      ...
      return new ItemSongBinding((ConstraintLayout) rootView, cardArt, tvArtist, tvDuration,
          tvTitle);
    }
